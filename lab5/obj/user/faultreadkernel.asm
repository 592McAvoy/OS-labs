	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021c:	0f be 80 91 11 80 00 	movsbl 0x801191(%eax),%eax
  800223:	50                   	push   %eax
...
0080026b <vprintfmt>:
{
  ...
  8002be:	ff 24 85 80 13 80 00 	jmp    *0x801380(,%eax,4)
  ...
  80039d:	8b 14 85 e0 14 80 00 	mov    0x8014e0(,%eax,4),%edx
  8003a4:	85 d2                	test   %edx,%edx
  8003a6:	74 18                	je     8003c0 <vprintfmt+0x155>
				printfmt(putch, putdat, "%s", p);
  8003a8:	52                   	push   %edx
  8003a9:	68 b2 11 80 00       	push   $0x8011b2
  8003ae:	53                   	push   %ebx
  8003af:	56                   	push   %esi
  ...
  8003c0:	50                   	push   %eax
  8003c1:	68 a9 11 80 00       	push   $0x8011a9
  8003c6:	53                   	push   %ebx
  8003c7:	56                   	push   %esi
  ...
  8003e8:	b8 a2 11 80 00       	mov    $0x8011a2,%eax
  ...
  80073b:	68 00 13 80 00       	push   $0x801300
  800740:	68 b2 11 80 00       	push   $0x8011b2
  800745:	53                   	push   %ebx
  800746:	56                   	push   %esi
  ...
  800757:	68 c8 12 80 00       	push   $0x8012c8
  80075c:	68 b2 11 80 00       	push   $0x8011b2
  800761:	53                   	push   %ebx
  800762:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800bef:	68 20 15 80 00       	push   $0x801520
  800bf4:	6a 33                	push   $0x33
  800bf6:	68 3d 15 80 00       	push   $0x80153d
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c70:	68 20 15 80 00       	push   $0x801520
  800c75:	6a 33                	push   $0x33
  800c77:	68 3d 15 80 00       	push   $0x80153d
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cb2:	68 20 15 80 00       	push   $0x801520
  800cb7:	6a 33                	push   $0x33
  800cb9:	68 3d 15 80 00       	push   $0x80153d
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cf4:	68 20 15 80 00       	push   $0x801520
  800cf9:	6a 33                	push   $0x33
  800cfb:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_swap(envid_t envid)
{
  ...
  800d35:	68 20 15 80 00       	push   $0x801520
  800d3a:	6a 33                	push   $0x33
  800d3c:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d77:	68 20 15 80 00       	push   $0x801520
  800d7c:	6a 33                	push   $0x33
  800d7e:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800db9:	68 20 15 80 00       	push   $0x801520
  800dbe:	6a 33                	push   $0x33
  800dc0:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfb:	68 20 15 80 00       	push   $0x801520
  800e00:	6a 33                	push   $0x33
  800e02:	68 3d 15 80 00       	push   $0x80153d
...
sys_ipc_recv(void *dstva)
{
  ...
  800e5f:	68 20 15 80 00       	push   $0x801520
  800e64:	6a 33                	push   $0x33
  800e66:	68 3d 15 80 00       	push   $0x80153d
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ecd:	56                   	push   %esi
  800ece:	50                   	push   %eax
  800ecf:	68 4c 15 80 00       	push   $0x80154c
  ...
  800ee0:	e8 08 f2 ff ff       	call   8000ed <vcprintf>
	cprintf("\n");
  800ee5:	c7 04 24 70 15 80 00 	movl   $0x801570,(%esp)
