...
sys_env_destroy(envid_t envid)
{
  ...
  800112:	68 6f 11 80 00       	push   $0x80116f
  800117:	6a 33                	push   $0x33
  800119:	68 8c 11 80 00       	push   $0x80118c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800193:	68 6f 11 80 00       	push   $0x80116f
  800198:	6a 33                	push   $0x33
  80019a:	68 8c 11 80 00       	push   $0x80118c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d5:	68 6f 11 80 00       	push   $0x80116f
  8001da:	6a 33                	push   $0x33
  8001dc:	68 8c 11 80 00       	push   $0x80118c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800217:	68 6f 11 80 00       	push   $0x80116f
  80021c:	6a 33                	push   $0x33
  80021e:	68 8c 11 80 00       	push   $0x80118c
...
sys_env_swap(envid_t envid)
{
  ...
  800258:	68 6f 11 80 00       	push   $0x80116f
  80025d:	6a 33                	push   $0x33
  80025f:	68 8c 11 80 00       	push   $0x80118c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80029a:	68 6f 11 80 00       	push   $0x80116f
  80029f:	6a 33                	push   $0x33
  8002a1:	68 8c 11 80 00       	push   $0x80118c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002dc:	68 6f 11 80 00       	push   $0x80116f
  8002e1:	6a 33                	push   $0x33
  8002e3:	68 8c 11 80 00       	push   $0x80118c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80031e:	68 6f 11 80 00       	push   $0x80116f
  800323:	6a 33                	push   $0x33
  800325:	68 8c 11 80 00       	push   $0x80118c
...
sys_ipc_recv(void *dstva)
{
  ...
  800382:	68 6f 11 80 00       	push   $0x80116f
  800387:	6a 33                	push   $0x33
  800389:	68 8c 11 80 00       	push   $0x80118c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003f0:	56                   	push   %esi
  8003f1:	50                   	push   %eax
  8003f2:	68 9c 11 80 00       	push   $0x80119c
  ...
  800403:	e8 56 00 00 00       	call   80045e <vcprintf>
	cprintf("\n");
  800408:	c7 04 24 bf 11 80 00 	movl   $0x8011bf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80058d:	0f be 80 c1 11 80 00 	movsbl 0x8011c1(%eax),%eax
  800594:	50                   	push   %eax
...
008005dc <vprintfmt>:
{
  ...
  800719:	52                   	push   %edx
  80071a:	68 e2 11 80 00       	push   $0x8011e2
  80071f:	53                   	push   %ebx
  800720:	56                   	push   %esi
  ...
  800731:	50                   	push   %eax
  800732:	68 d9 11 80 00       	push   $0x8011d9
  800737:	53                   	push   %ebx
  800738:	56                   	push   %esi
  ...
  800759:	b8 d2 11 80 00       	mov    $0x8011d2,%eax
  ...
  800aac:	68 30 13 80 00       	push   $0x801330
  800ab1:	68 e2 11 80 00       	push   $0x8011e2
  800ab6:	53                   	push   %ebx
  800ab7:	56                   	push   %esi
  ...
  800ac8:	68 f8 12 80 00       	push   $0x8012f8
  800acd:	68 e2 11 80 00       	push   $0x8011e2
  800ad2:	53                   	push   %ebx
  800ad3:	56                   	push   %esi
