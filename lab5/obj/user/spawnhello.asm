...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 64 25 80 00       	push   $0x802564
  80006f:	6a 09                	push   $0x9
  800071:	68 7c 25 80 00       	push   $0x80257c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f2:	56                   	push   %esi
  8000f3:	50                   	push   %eax
  8000f4:	68 98 25 80 00       	push   $0x802598
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	0f be 80 bb 25 80 00 	movsbl 0x8025bb(%eax),%eax
  800296:	50                   	push   %eax
...
008002de <vprintfmt>:
{
  ...
  800433:	50                   	push   %eax
  800434:	68 d3 25 80 00       	push   $0x8025d3
  800439:	53                   	push   %ebx
  80043a:	56                   	push   %esi
  ...
  80045b:	b8 cc 25 80 00       	mov    $0x8025cc,%eax
  ...
  8007ae:	68 28 27 80 00       	push   $0x802728
  ...
  8007ca:	68 f0 26 80 00       	push   $0x8026f0
