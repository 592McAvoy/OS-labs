...
// Create a child process from a program image loaded from the file system,
// Swap child env with current env to get new prog environment
// Destroy child env, run prog in current env
